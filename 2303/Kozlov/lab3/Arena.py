...
import tf
import math
from RoboNinja import RoboNinja
...
def server():
    ...
    robots["robot0"] = RoboNinja("robot0", [0, 1, 0], 1000, [4, 0])
    robots["robot1"] = RoboNinja("robot1", [0.5, 0.35, 0.2], 1000, [-4, 0])
